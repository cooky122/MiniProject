...
const Comments = [
  {comment_id:1, post_id:1, mem_id:"user02", content:"축하드립니다!", create_time:<DateFormat/>, like_count: 10},
  {comment_id:2, post_id:2, mem_id:"user03", content:"저는 김치찌개 추천이요.", create_time:<DateFormat/>, like_count: 2},
  {comment_id:3, post_id:3, mem_id:"user04", content:"고객센터에 문의해보세요.", create_time:<DateFormat/>, like_count: 5},
  {comment_id:4, post_id:4, mem_id:"user05", content:"좋은 자료 감사합니다.", create_time:<DateFormat/>, like_count: 7},
  {comment_id:5, post_id:5, mem_id:"user01", content:"참여 감사합니다!", create_time:<DateFormat/>, like_count: 1},
];
